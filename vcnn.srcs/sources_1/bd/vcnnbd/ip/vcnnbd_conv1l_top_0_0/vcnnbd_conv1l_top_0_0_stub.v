...
//               /home/gokul/playground/ece594bb/fpgacc/vcnn/vcnn.srcs/sources_1/bd/vcnnbd/ip/vcnnbd_conv1l_top_0_0/vcnnbd_conv1l_top_0_0_stub.v
...
module vcnnbd_conv1l_top_0_0(clk, rstn, ap_start, ap_ready, ap_done, 
  ...
  output_bram_wr_in)
/* synthesis syn_black_box black_box_pad_pin="clk,rstn,ap_start,ap_ready,ap_done,input_bram_rd_clk,input_bram_rd_rst,input_bram_rd_en,input_bram_rd_wen,input_bram_rd_adddr[11:0],input_bram_rd_dout[15:0],input_bram_rd_din[15:0],weight_bram_rd_clk,weight_bram_rd_rst,weight_bram_rd_en,weight_bram_rd_wen,weight_bram_rd_adddr[8:0],weight_bram_rd_dout[15:0],weight_bram_rd_din[15:0],output_bram_wr_clk,output_bram_wr_rst,output_bram_wr_en,output_bram_wr_wen,output_bram_wr_addr[13:0],output_bram_wr_dout[15:0],output_bram_wr_in[15:0]" */;
  input clk;
  input rstn;
  input ap_start;
  output ap_ready;
