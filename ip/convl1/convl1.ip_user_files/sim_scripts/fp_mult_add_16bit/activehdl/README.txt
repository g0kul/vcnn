...
#
# Generated by export_simulation on Sat Mar 24 23:31:20 PDT 2018
#
################################################################################
...
switch to the './fp_mult_add_16bit.sh' script.

./fp_mult_add_16bit.sh -reset_run
...
./fp_mult_add_16bit.sh -noclean_files

For more information on the script, please type './fp_mult_add_16bit.sh -help'.
