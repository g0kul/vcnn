...
HD_PWD='/home/gokul/playground/ece594bb/fpgacc/vcnn/ip/convl1/convl1.runs/fp_mult_add_16bit_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_mult_add_16bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_mult_add_16bit.tcl
