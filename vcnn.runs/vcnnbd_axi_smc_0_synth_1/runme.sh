...
HD_PWD='/home/gokul/playground/ece594bb/fpgacc/vcnn/vcnn.runs/vcnnbd_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vcnnbd_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vcnnbd_axi_smc_0.tcl
