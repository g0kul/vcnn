...
HD_PWD='/home/gokul/playground/ece594bb/fpgacc/vcnn/vcnn.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vcnnbd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vcnnbd_wrapper.tcl -notrace
