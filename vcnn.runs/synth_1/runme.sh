...
HD_PWD='/home/gokul/playground/ece594bb/fpgacc/vcnn/vcnn.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vcnnbd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vcnnbd_wrapper.tcl
