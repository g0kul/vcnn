...
HD_PWD='/home/gokul/playground/ece594bb/fpgacc/vcnn/vcnn.runs/vcnnbd_output_bram_mem_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vcnnbd_output_bram_mem_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vcnnbd_output_bram_mem_0.tcl
