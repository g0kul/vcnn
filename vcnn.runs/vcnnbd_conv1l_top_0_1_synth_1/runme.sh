...
HD_PWD='/home/gokul/playground/ece594bb/fpgacc/vcnn/vcnn.runs/vcnnbd_conv1l_top_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vcnnbd_conv1l_top_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vcnnbd_conv1l_top_0_1.tcl
